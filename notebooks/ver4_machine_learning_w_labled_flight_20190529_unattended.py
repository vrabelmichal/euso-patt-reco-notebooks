...
data_snippets_dir = 'ver4_machine_learning_w_labeled_flight_20190529'
...
# IMPORTANT - Initetionally commented - entries with NaN columns are dropped
...
learning_data__kbest_var_th_sc_columns_sorted_table.iloc[:100]
...
learning_data__all_var_th_sc_columns_sorted_table.iloc[:100]
...
#extra_trees_cls_on_train_rfecv_for_crossvalidation_per_trueenergy_results =     cross_val_score_meta_scored(
...
#plt.close('all')
#for xscale in ['linear', 'log']:
    #fig, ax, errbr =         plot_efficiency_stat(extra_trees_cls_on_train_rfecv_for_crossvalidation_per_trueenergy_results, 
                             #plotted_stat='sensitivity', plotted_yerr_stat='positive_sm_confint_beta_95', num_steps = 20, xscale=xscale,
                             #calc_cls_stats_from_numbers_func=calc_cls_stats_from_numbers_with_sm_proportion_confint,
                             #xlabel = 'True energy [MeV]', ylabel = 'Sensitivity', 
                             #figsize = (10,6), ylim=(0,1.2), show=False)
