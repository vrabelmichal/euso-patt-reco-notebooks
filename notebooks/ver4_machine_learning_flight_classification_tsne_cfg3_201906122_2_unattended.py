...
print('Num all selected:', len(flight_df_nonan))
...
print('Num estimate positive samples', np.count_nonzero(flight_df_nonan[cls_column]))
...
print('Fraction of selected events', np.count_nonzero(flight_df_nonan[cls_column])/len(flight_df_nonan))
...
print('Fraction of all events', np.count_nonzero(flight_df_nonan[cls_column])/num_all_events)
...
print('fraction of all events in gtu [36, 60]',
...
print('fraction of all packets triggered in gtu [36, 60]',
