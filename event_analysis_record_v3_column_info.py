...
class EventAnalysisRecordV3ColumnInfo(BaseAnalysisRecordColumnInfo):
    ...
    data_table_columns_per_dimension = [
        ('trigg_{dims}_hough__dbscan_num_clusters_above_thr1', 'integer NOT NULL'),
        ('trigg_{dims}_hough__dbscan_num_clusters_above_thr2', 'integer NOT NULL'),
        ('trigg_{dims}_hough__max_peak_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__max_peak_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_avg_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_avg_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_avg_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_max_clu_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_max_clu_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_max_clu_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_max_clu_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_max_clu_major_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_max_clu_major_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_max_clu_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr1_max_clu_avg_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_max_clu_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr2_max_clu_avg_phi', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_max_clu_avg_rho', 'real NOT NULL'),
        ('trigg_{dims}_hough__peak_thr3_max_clu_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__dbscan_num_clusters_above_thr1', 'real NOT NULL'),
        ('{dims}_hough__dbscan_num_clusters_above_thr2', 'real NOT NULL'),
        ('{dims}_hough__dbscan_num_clusters_above_thr3', 'real NOT NULL'),
        ('{dims}_hough__dbscan_num_clusters_above_thr4', 'real NOT NULL'),
        ('{dims}_hough__max_peak_rho', 'real NOT NULL'),
        ('{dims}_hough__max_peak_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_max_clu_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_max_clu_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_max_clu_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_max_clu_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_max_clu_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_max_clu_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_max_clu_major_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_max_clu_major_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_max_clu_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr1_max_clu_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_max_clu_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr2_max_clu_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_max_clu_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr3_max_clu_avg_phi', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_max_clu_avg_rho', 'real NOT NULL'),
        ('{dims}_hough__peak_thr4_max_clu_avg_phi', 'real NOT NULL'),
