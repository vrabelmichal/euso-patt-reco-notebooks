    ...
    def __init__(self):
        ...
        if not self.__class__.extra_attr_method_mapping:
            ...
            d = {
                ...
                'max_triggered_pixel_group_size': lambda o: max([len(g) for g in o.triggered_pixel_groups]) if len(
                    o.triggered_pixel_groups) > 0 else -1,
                'avg_trigger_group_size': lambda o: sum([len(g) for g in o.triggered_pixel_groups]) / len(
                    o.triggered_pixel_groups) if len(o.triggered_pixel_groups) > 0 else -1.,
                'triggered_pixels_x_y_hough_transform__max_peak_line_rot': lambda
                    o: o.triggered_pixels_x_y_hough_transform__max_peak_phi + np.pi / 2,
                'triggered_pixels_x_y_hough_transform__max_peak_line_coord_0_x': lambda o:
                o.triggered_pixels_x_y_hough_transform__max_peak_line_coords[0][1],
                'triggered_pixels_x_y_hough_transform__max_peak_line_coord_0_y': lambda o:
                o.triggered_pixels_x_y_hough_transform__max_peak_line_coords[0][0],
                'triggered_pixels_x_y_hough_transform__max_peak_line_coord_1_x': lambda o:
                o.triggered_pixels_x_y_hough_transform__max_peak_line_coords[1][1],
                'triggered_pixels_x_y_hough_transform__max_peak_line_coord_1_y': lambda o:
                o.triggered_pixels_x_y_hough_transform__max_peak_line_coords[1][0],
                ...
                'triggers_x_y_neighbourhood_area': lambda o: o.triggers_x_y_neighbourhood_dimensions[1] *
                                                             o.triggers_x_y_neighbourhood_dimensions[0] if len(
                    o.triggers_x_y_neighbourhood_dimensions) > 1 else -1,
